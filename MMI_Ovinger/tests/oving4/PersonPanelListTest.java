...
public class PersonPanelListTest extends JFCTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        person1 = createPerson("Hallvard Trætteberg", "16.nov.1966", Gender.MALE,
                "hal@idi.ntnu.no", 179);
        person2 = createPerson("Marit Reitan", "17.apr.1964", Gender.FEMALE,
                "marit.reitan@idi.ntnu.no", 176);
        person3 = createPerson("Jens Reitan Trætteberg", "14.jan.1997",
        		Gender.MALE, null, 145);
        person4 = createPerson("Anne Trætteberg Reitan", "13.jun.1998",
